...
results = agent.run(
            ...
            2. Google the careers page of the first entry
            3. Create a Python function to scrape the careers page for the following information: company name, job title, job description URL
            4. Run the function using PytonREPL and create a JSON object from its output
            5. output the function and JSON object
            """
)