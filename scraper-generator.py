...
results = agent.run(
            ...
            3. Create a Python function to scrape the careers page for the following information about each job on it: company name, job title, job description URL
            4. Run the function using PythonREPL to confirm it works
            5. output the function
            """
)